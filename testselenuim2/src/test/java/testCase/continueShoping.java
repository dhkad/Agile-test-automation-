...
public class continueShoping extends BaseTest{
	@Test
	...
	addtocard.click();
	 ...
	 WebElement conShop= driver.findElement(By.id("continue-shopping"));
	 Thread.sleep(500); 
	 conShop.click();
	 
	 
	 Reporter.log("Continue shopping button test", true);
	 String expectedur2 = "https://www.saucedemo.com/inventory.html";
